...
export const DEFAULT_GAME_CONFIG: GameConfig = {
  ...
  locations: [
    ...
    { id: "westmount", name: "Westmount", policePresence: 42, minDrug: 4, maxDrug: 8 },
  ...
  dealers: [
    ...
    },
    {
      ...
      drugIds: ["cocaine", "acid", "mda", "shrooms", "peyote"],
      traits: ["connected", "loyal"],
      greed: 48,
      violence: 18,
      loyalty: 72,
      ...
      guardCount: 0,
      dialogueLines: [
        "Johnathan traces a little vector in the air and asks if you can feel the neighbourhood gradient, my guy.",
